...
parser.add_argument('--visualize_holdings', type=util.str2bool, nargs='?', const=True, default=True, help='should create holdings gif?')
...
visualize_holdings = args.visualize_holdings
# END SET VARS #
...
test(test_data, agent, init_cash, log_interval_steps, log_comet, experiment, visualize_holdings=visualize_holdings)
